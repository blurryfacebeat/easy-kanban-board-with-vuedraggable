      ...
      <div class="col-md-3">
        <div class="p-2 alert alert-secondary">
          ...
          <draggable class="list-group kanban-column" :list="arrBacklog" group="tasks">
            <div class="list-group-item" v-for="element of arrBacklog" :key="element.name">
              {{ element.name }}
            </div>
          </draggable>
        </div>
      ...
      <div class="col-md-3">
        <div class="p-2 alert alert-primary">
          ...
          <draggable class="list-group kanban-column" :list="arrInProgress" group="tasks">
            <div class="list-group-item" v-for="element of arrInProgress" :key="element.name">
              {{ element.name }}
            </div>
          </draggable>
        </div>
      ...
      <div class="col-md-3">
        <div class="p-2 alert alert-warning">
          ...
          <draggable class="list-group kanban-column" :list="arrTested" group="tasks">
            <div class="list-group-item" v-for="element of arrTested" :key="element.name">
              {{ element.name }}
            </div>
          </draggable>
        </div>
      ...
      <div class="col-md-3">
        <div class="p-2 alert alert-success">
          ...
          <draggable class="list-group kanban-column" :list="arrDone" group="tasks">
            <div class="list-group-item" v-for="element of arrDone" :key="element.name">
              {{ element.name }}
            </div>
          </draggable>
        </div>
